...
[![LinkedIn][https://www.linkedin.com/in/raphel-levy-828739198/]]
...
There is a requeriment.txt install it and you should be fine 

### Installation

1. Have a instagram acount (https://instagram.com)
2. Clone the repo
```sh
git clone git@github.com:Pyshios/instaint.git
```
3. Install requeriments.txt

4. Enter your details
![alt text](https://ibb.co/RDRTrBC)
